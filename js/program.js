  ...
  sessions: {
    "lower-power": {
      ...
      exercises: [
        ...
        { name: "Back Squat", sets: 4, reps: "5", rest: "2–3 min", notes: "Main strength lift. RPE 7–8. Add load once all 4 sets hit 5 clean reps.", increment: 5 },
        { name: "Romanian Deadlift", sets: 3, reps: "8", rest: "2 min", notes: "Posterior chain — hamstrings/glutes for sprinting and tackling.", increment: 5 },
        { name: "Bulgarian Split Squat", sets: 3, reps: "10 / leg", rest: "90 sec", notes: "Unilateral strength + knee stability for cutting.", increment: 2 },
        { name: "Standing Calf Raise", sets: 3, reps: "15", rest: "60 sec", increment: 2 },
    ...
    "upper-push": {
      ...
      exercises: [
        ...
        { name: "Dumbbell Lateral Raise", sets: 3, reps: "12–15", rest: "60 sec", increment: 1 },
      ],
    },
    ...
    "upper-pull": {
      ...
      exercises: [
        { name: "Weighted Pull-Up", sets: 4, reps: "6–8", rest: "2 min", increment: 2.5 },
        { name: "Barbell Bent-Over Row", sets: 4, reps: "6–8", rest: "2 min", increment: 2.5 },
        { name: "Single-Arm Dumbbell Row", sets: 3, reps: "10 / arm", rest: "90 sec", increment: 2 },
        { name: "Barbell or DB Curl", sets: 3, reps: "10–12", rest: "60 sec", increment: 1 },
        { name: "Hammer Curl", sets: 3, reps: "12", rest: "60 sec", increment: 1 },
    ...
    accessory: {
      ...
      optional: true,
      exercises: [
        { name: "Dumbbell Shoulder Press", sets: 3, reps: "10", rest: "60 sec", increment: 2 },
        { name: "Barbell Bench Press", sets: 3, reps: "12", rest: "60 sec", notes: "Light accessory pump set — no row machine at home, so this replaces chest-supported row for extra volume.", increment: 2.5 },
        { name: "Barbell Curl", sets: 3, reps: "12", rest: "60 sec", increment: 1 },
        { name: "Overhead Triceps Extension", sets: 3, reps: "12", rest: "60 sec", increment: 1 },
